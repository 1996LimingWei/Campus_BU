...
// Forum Types (独立于发现板块)
export type ForumCategory = 'general' | 'activity' | 'guide' | 'lost_found' | 'marketplace' | 'teaming' | 'confession' | 'help';
export type ForumSort = 'latest_reply' | 'latest_post' | 'recommended' | 'hot';
